    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="col-lg-10">
        ...
        <div class="col-lg-2">
            ...
            <?php foreach ($product_badges as $product_badge) { ?>
            <div class="product-badges">
                <img src="<?php echo $product_badge['thumb']; ?>" title="<?php echo $product_badge['title']; ?>" alt="<?php echo $product_badge['title']; ?>" />
                <span><?php if($product_badge['title'] != '') { echo $product_badge['title']; } ?></span>
            </div>
            <?php } ?>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#cart span.cart-items-count').html(json['total']);
