<div id="cart" class="btn-group btn-block">
  <button id="home-cart-button" type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><i class="fa fa-shopping-cart"></i> <span id="cart-total"><?php echo $text_items; ?></span></button>
...
<script>
    $("#home-cart-button").mouseover(function() {
        console.log('a');
    }); 
    </script>
