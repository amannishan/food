...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
          <div class="col-sm-6">
      <div class="form-horizontal" id="collapse-payment-address">
  <?php if ($addresses) { ?>
  <div class="radio">
    <label>
  ...
  <?php } ?>
  <br />
   <div class="panel-collapse" id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
      <h2>Billing Information:</h2>      
<!--*  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">*/-->
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-payment-firstname"><?php echo $entry_firstname; ?></label>
      <div class="col-sm-10">
        <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-payment-lastname"><?php echo $entry_lastname; ?></label>
      <div class="col-sm-10">
        <input type="text" name="lastname" value="" placeholder="<?php echo $entry_lastname; ?>" id="input-payment-lastname" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-payment-address-1"><?php echo $entry_address_1; ?></label>
      <div class="col-sm-10">
        <input type="text" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-payment-address-1" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-payment-city"><?php echo $entry_city; ?></label>
      <div class="col-sm-10">
        <input type="text" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-payment-country"><?php echo $entry_country; ?></label>
      <div class="col-sm-10">
	...
	<div class="row"><label class="col-sm-4 control-label" for="input-payment-zone"><?php echo $entry_zone; ?></label>
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-4">
        <input type="text" name="postcode" value="" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" />
          ...
          <div class="col-sm-6">
              <div class="form-horizontal" id="collapse-shipping-address">
  <?php if ($addresses) { ?>
  <div class="radio">
    <label>
  ...
  <?php } ?>
  <br />
  <div id="shipping-new" class="panel-collapse" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
      <h2>Shipping Information:
      <input type="checkbox" id="same_shipping_information" name="same_shipping_information" value="1" />(same as billing information)
      </h2>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-shipping-firstname"><?php echo $entry_firstname; ?></label>
      <div class="col-sm-10">
        <input type="text" name="shipping-firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-shipping-firstname" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-shipping-lastname"><?php echo $entry_lastname; ?></label>
      <div class="col-sm-10">
        <input type="text" name="shipping-lastname" value="" placeholder="<?php echo $entry_lastname; ?>" id="input-shipping-lastname" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-shipping-address-1"><?php echo $entry_address_1; ?></label>
      <div class="col-sm-10">
        <input type="text" name="shipping-address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-shipping-address-1" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-shipping-city"><?php echo $entry_city; ?></label>
      <div class="col-sm-10">
        <input type="text" name="shipping-city" value="" placeholder="<?php echo $entry_city; ?>" id="input-shipping-city" class="form-control" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-12 control-label" for="input-shipping-country"><?php echo $entry_country; ?></label>
      <div class="col-sm-10">
        <select name="shipping-country_id" id="input-shipping-country" class="form-control">
          <option value=""><?php echo $text_select; ?></option>
          <?php foreach ($countries as $country) { ?>
          <?php if ($country['country_id'] == $country_id) { ?>
          <option value="<?php echo $country['country_id']; ?>" selected="selected"><?php echo $country['name']; ?></option>
	...
	<div class="row"><label class="col-sm-4 control-label" for="input-shipping-zone"><?php echo $entry_zone; ?></label>
	<label class="col-sm-4 control-label" for="input-shipping-postcode"><?php echo $entry_postcode; ?></label>
	</div>
    <div class="form-group required">
      
      <div class="col-sm-4">
        <select name="shipping-zone_id" id="input-shipping-zone" class="form-control">
        </select>
      </div>
     
      <div class="col-sm-4">
        <input type="text" name="shipping-postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="form-control" />
      </div>
    </div>
...
<!--*  <div class="buttons clearfix">
    <div class="pull-right">
      ...
      <div class="row">
          ...
          <div class="col-sm-6">
              <input type="hidden"  value="authorizenet_aim" name="payment_method">
              <?php echo $payment; ?>
          </div>
      <div class="col-sm-6">
...
$(document).delegate('#button-payment-address', 'click', function() {
    $.ajax({
        ...
        type: 'post',
        data: $('#collapse-payment-address input[type=\'text\'], #collapse-payment-address input[type=\'date\'], #collapse-payment-address input[type=\'datetime-local\'], #collapse-payment-address input[type=\'time\'], #collapse-payment-address input[type=\'password\'], #collapse-payment-address input[type=\'checkbox\']:checked, #collapse-payment-address input[type=\'radio\']:checked, #collapse-payment-address input[type=\'hidden\'], #collapse-payment-address textarea, #collapse-payment-address select,#collapse-shipping-address input[type=\'text\'], #collapse-shipping-address input[type=\'password\'], #collapse-shipping-address textarea, #collapse-shipping-address input[type=\'radio\']:checked, #collapse-shipping-address select,#collapse-shipping-method input[type=\'radio\']:checked, #collapse-shipping-method textarea'),
        dataType: 'json',
        beforeSend: function() {
...
$(document).delegate('#button-shipping-address', 'click', function() {
    $.ajax({
        ...
        type: 'post',
        data: $('#collapse-shipping-address input[type=\'text\'], #collapse-shipping-address input[type=\'password\'], #collapse-shipping-address textarea, #collapse-shipping-address select'),
        dataType: 'json',
        beforeSend: function() {
...
<script type="text/javascript"><!--
$(document).delegate('#same_shipping_information', 'click', function() {
        if($("#same_shipping_information").is(':checked')) {
                if($('#input-payment-firstname').val() != '') {
                $('#input-shipping-firstname').val($('#input-payment-firstname').val());
            }
            if($('#input-payment-lastname').val() != '') {
                $('#input-shipping-lastname').val($('#input-payment-lastname').val());
            }
            if($('#input-payment-address-1').val() != '') {
                $('#input-shipping-address-1').val($('#input-payment-address-1').val());
            }
            if($('#input-payment-city').val() != '') {
                $('#input-shipping-city').val($('#input-payment-city').val());
            }
            if($('#input-payment-postcode').val() != '') {
                $('#input-shipping-postcode').val($('#input-payment-postcode').val());
            }
        } else {
...
<script type="text/javascript"><!--
$('#collapse-shipping-address select[name=\'shipping-country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=checkout/checkout/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
			$('#collapse-shipping-address select[name=\'shipping-country_id\']').after(' <i class="fa fa-circle-o-notch fa-spin"></i>');
		},
		complete: function() {
			$('.fa-spin').remove();
		},
		success: function(json) {
			if (json['postcode_required'] == '1') {
				$('#collapse-shipping-address input[name=\'shipping-postcode\']').parent().parent().addClass('required');
			} else {
				$('#collapse-shipping-address input[name=\'shipping-postcode\']').parent().parent().removeClass('required');
			}
			...
			$('#collapse-shipping-address select[name=\'shipping-zone_id\']').html(html);
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
...
$('#collapse-shipping-address select[name=\'shipping-country_id\']').trigger('change');
//--></script>
<script type="text/javascript"><!--
