  ...
  <div id="collapse-shipping" class="panel-collapse">
    <div class="panel-body">
      ...
      <div class="form-horizontal">
        ...
        <div class="form-group required pd-bottom">
          <label class="col-sm-4 control-label" for="input-postcode"><?php echo $entry_postcode; ?></label>
          <div class="col-sm-4">
            <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control" />
          </div>
		  <div class="col-sm-4">
		  <button type="button" id="button-quote" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_quote; ?></button></div>
        </div>
